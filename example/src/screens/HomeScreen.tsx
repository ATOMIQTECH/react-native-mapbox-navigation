...
export default function HomeScreen() {
  ...
  >('checking')
  const [capturedLocation, setCapturedLocation] = useState<LocationUpdate | undefined>(undefined)
      ...
      {!hasLocationPermission ? (
        <View style={styles.permissionOverlay}>
          ...
          <Text style={styles.permissionText}>
            Grant location access to start embedded navigation and capture device coordinates in
            this test app.
          </Text>
          <Pressable
            onPress={() => {
        ...
        <View pointerEvents='box-none' style={styles.supportOverlay}>
          ...
          <View style={styles.supportSheet}>
            ...
            <Text style={styles.supportText}>
              This is React UI from the example app, separate from the package bottom sheet.
            </Text>
